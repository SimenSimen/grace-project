<template>
  <div class="product-desc-type-1">
    <h1 class="font-bold text-2xl lg:text-4xl text-blue-700 mb-2 lg:mb-4">日式葡萄風味凍</h1>
    ...
    <p class="text-gray-500 mb-2">糖、鹿角菜膠、關華豆膠、香料、食用色素(紅色40號、藍色1號</p>
