<template>
  <div class="product-desc-type-1">
    <h1 class="font-bold text-2xl lg:text-4xl text-blue-700 mb-2 lg:mb-4">日式芒果風味布丁</h1>
    ...
    <p class="text-gray-500 mb-2">
      糖、奶精(葡萄糖漿、完全氫化棕櫚仁油、乾酪素鈉、檸檬酸鉀、脂肪酸甘油酯、二氧化矽、婀娜多)、鹿角菜膠、關華豆膠、香料、食用色素(黃色5號、黃色4號)
    </p>
    ...
    <p class="text-gray-500 mb-2">
      ...
      <b>1</b> 加入1公斤布丁粉快速攪拌均勻，溶解後請再繼續攪拌
      <b>2</b> 分鐘(布丁的口感會更好)，即可分杯成型。
    </p>
